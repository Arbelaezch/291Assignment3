-- Data prepared by Ryan Kang, rkang1@ualberta.ca -- Updated for Assignment 3 by Christian Arby :D
-- Published on Oct 4, 2019
-- Modified Oct 10, 2019
-- Then Modified again Oct 24, 2019 
...
insert into payments values ('401','1965-08-20','5');
insert into payments values ('401','1965-08-21','5');
insert into payments values ('410','2019-06-21','312');
insert into payments values ('415','2019-06-21','315');
insert into payments values ('416','2019-06-21','315');

insert into users values ('age','test','a','Michael','Fox','San Fran');
insert into users values ('agent','password','a','Throw','Away','Edmonton');
insert into users values ('ageerino','test','a','Davood','Rafiei','Calgary');
insert into users values ('aggent3','test','a','Mickey','Mouse','Melbourne');
insert into users values ('lastone','test','a','Minnie','Mouse','St. Louis');
insert into users values ('off','test','o','Walt','Disney','Fort Mac');
insert into users values ('officer','password','o','Mia','Warner','Toronto');
insert into users values ('officer2','test','o','Stacey','Long','Quebec City');
